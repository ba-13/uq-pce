...
plt.figure()
plt.plot(ps, rerror_means, "o-", label="Relative Mean error")
plt.plot(ps, rerror_vars, "o-", label="Relative Variance error")
plt.yscale("log")
...
plt.figure()
plt.plot(Ns, rerror_means, "o-", label="Relative Mean error")
plt.plot(Ns, rerror_vars, "o-", label="Relative Variance error")
plt.yscale("log")
